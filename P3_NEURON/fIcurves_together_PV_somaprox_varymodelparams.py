...
varyE_bool = True
varyE = [30,40,50,53,60,65,70]#[-60,-53,-30,-10,10,30,60]
varyg = 'None'
...
models  = [489931686]#[488462965]#[478513407]#[485694403] #[478513437] #  [478513407,478513437,488462965] # 
Nmodels = len(models)

outfolder = 'Results/Soma%i/' % somasize
plotname  = outfolder + 'fIcurves_baspv_somaprox'+plotstring+'.png' 
...
for l in range(Nvary):
    ...
    outfilename_all = outfolder + 'fIcurves_baspv_somaprox'+plotstring+changestring+'.txt' 
    ...
    for i in range(NI):
        ...
        for j in range(Nmodels):
            ...
            outfilename = infolder+'baspv_cm'+str(cm)+'_idur%i_iamp'%idur+str(iamp)+'_vinit'+str(v_init)+changestring+'_sprx_If.txt'
