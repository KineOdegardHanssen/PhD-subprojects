...
outfilename = outfolder +'idur%i_iamp' % idur+str(iamp)+ '_'+str(testmodel)+ '_'+ textsnippet+ '_vinit'+str(v_init)+'_addedRa_Cm_manual.txt'
plotname    = outfolder +'idur%i_iamp' % idur+str(iamp)+ '_'+str(testmodel)+ '_'+ textsnippet+ '_vinit'+str(v_init)+'_addedRa_Cm_manual.png'
...
for i in range(N):
    ...
    if varywhichcm=='a':
        ...
        cm_dend = varycm[i]
    # Input file name
    filename = folder +'idur%i_iamp' % idur+str(iamp)+'_cmsoma' + str(cm_soma) + '_cmdend' + str(cm_dend) + '_cmaxon'+ str(cm_axon) + '_vinit'+str(v_init)+'_addedRa_Cmtotal_manual.txt'
