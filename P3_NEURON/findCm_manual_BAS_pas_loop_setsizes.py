...
folder = 'Results/IStim/Soma%i/dendlen%i/denddiam%i/' % (somasize,dendlen,denddiam)+'current_idur%i_iamp'% idur+str(iamp)+'/'
outfilename = folder +'baspass_cms_idur%i_iamp' % idur+str(iamp)+'_Ra'+str(Ra)+'_vinit'+str(v_init)+'_pas_Cm'
outfilename_tau = folder +'baspass_cms_idur%i_iamp' % idur+str(iamp)+'_Ra'+str(Ra)+'_vinit'+str(v_init)+'_pas_tau'
if long==True:
...
for cm in cms:
    ...
    testit=False # I have confidence in this code now
    if testit==True:
        N = 100*idur
