...
if plotvsC==True:
    ...
    plotname = folder +'baspass_cms_idur%i_iamp' % idur+str(iamp)+'_Ra%i_gpas'%Ra+str(gpas)+'_vpas' +str(vpas)+'_vinit'+str(v_init)+'_pas_Vt.png'
    plotname_2 = folder +'baspass_cms_idur%i_iamp' % idur+str(iamp)+'_Ra%i_gpas'%Ra+str(gpas)+'_vpas' +str(vpas)+'_vinit'+str(v_init)+'_pas_Vt_zoomed.png'
    plotname_norm = folder +'baspass_cms_idur%i_iamp' % idur+str(iamp)+'_Ra%i_gpas'%Ra+str(gpas)+'_vpas' +str(vpas)+'_vinit'+str(v_init)+'_pas_Vt_normalized.png'
    plotname_crosses = folder +'baspass_cms_idur%i_iamp' % idur+str(iamp)+'_Ra%i_gpas'%Ra+str(gpas)+'_vpas' +str(vpas)+'_vinit'+str(v_init)+'_pas_Vt_withtaus.png'
    plotname_withfit = folder +'baspass_cms_idur%i_iamp' % idur+str(iamp)+'_Ra%i_gpas'%Ra+str(gpas)+'_vpas' +str(vpas)+'_vinit'+str(v_init)+'_pas_Vt_withfit.png'
    Vcut = 200
elif plotvsd==True:
    folder = 'Comparemodels/BAS_vs_somaonly_passive/dtexp%i/Varyds/' % dtexp
    plotname = folder +'baspass_cm'+str(cm)+'_varyds_dendlen'+str(dendlen)+'_idur%i_iamp' % idur+str(iamp)+'_Ra%i_gpas'%Ra+str(gpas)+'_vpas' +str(vpas)+'_vinit'+str(v_init)+'_pas_Vt.png'
    plotname_2 = folder +'baspass_cm'+str(cm)+'_varyds_dendlen'+str(dendlen)+'_idur%i_iamp' % idur+str(iamp)+'_Ra%i_gpas'%Ra+str(gpas)+'_vpas' +str(vpas)+'_vinit'+str(v_init)+'_pas_Vt_zoomed.png'
    plotname_norm = folder +'baspass_cm'+str(cm)+'_varyds_dendlen'+str(dendlen)+'_idur%i_iamp' % idur+str(iamp)+'_Ra%i_gpas'%Ra+str(gpas)+'_vpas' +str(vpas)+'_vinit'+str(v_init)+'_pas_Vt_normalized.png'
    plotname_crosses = folder +'baspass_cm'+str(cm)+'_varyds_dendlen'+str(dendlen)+'_idur%i_iamp' % idur+str(iamp)+'_Ra%i_gpas'%Ra+str(gpas)+'_vpas' +str(vpas)+'_vinit'+str(v_init)+'_pas_Vt_withtaus.png'
    plotname_withfit = folder +'baspass_cm'+str(cm)+'_varyds_dendlen'+str(dendlen)+'_idur%i_iamp' % idur+str(iamp)+'_Ra%i_gpas'%Ra+str(gpas)+'_vpas' +str(vpas)+'_vinit'+str(v_init)+'_pas_Vt_withfit.png'
    ...
    plotname = folder +'baspass_cm'+str(cm)+'_varyls_denddiam'+str(denddiam)+'_idur%i_iamp' % idur+str(iamp)+'_Ra%i_gpas'%Ra+str(gpas)+'_epas' +str(vpas)+'_vinit'+str(v_init)+'_pas_Vt.png'
    plotname_2 = folder +'baspass_cm'+str(cm)+'_varyls_denddiam'+str(denddiam)+'_idur%i_iamp' % idur+str(iamp)+'_Ra%i_gpas'%Ra+str(gpas)+'_epas' +str(vpas)+'_vinit'+str(v_init)+'_pas_Vt_zoomed.png'
    plotname_norm = folder +'baspass_cm'+str(cm)+'_varyls_denddiam'+str(denddiam)+'_idur%i_iamp' % idur+str(iamp)+'_Ra%i_gpas'%Ra+str(gpas)+'_epas' +str(vpas)+'_vinit'+str(v_init)+'_pas_Vt_normalized.png'
    plotname_crosses = folder +'baspass_cm'+str(cm)+'_varyls_denddiam'+str(denddiam)+'_idur%i_iamp' % idur+str(iamp)+'_Ra%i_gpas'%Ra+str(gpas)+'_epas' +str(vpas)+'_vinit'+str(v_init)+'_pas_Vt_withtaus.png'
    plotname_withfit = folder +'baspass_cm'+str(cm)+'_varyls_denddiam'+str(denddiam)+'_idur%i_iamp' % idur+str(iamp)+'_Ra%i_gpas'%Ra+str(gpas)+'_epas' +str(vpas)+'_vinit'+str(v_init)+'_pas_Vt_withfit.png'
    Vcut = idelay+25 # Suitable for cm=1.0. # COULD NEED TO UPDATE THIS. Possibly test for the value of cm.
    Vcut_zoom = idelay+5 # Also need to beware of this
...
for i in range(Npl):
    ...
    if plotvsC==True:
        ...
        infilename  = folder+'baspass_cm'+str(cm)+'_idur%.1f_iamp' % idur+str(iamp)+'_Ra%i_gpas'%Ra+str(gpas)+'_vpas' +str(vpas)+'_V.txt'
        ...
        if denddiam==0:
            ...
            infilename = somaonly_folder+'somaonly_cm'+str(cm)+'_idur%i_iamp'%idur+str(iamp)+'_Ra%i_vinit'%Ra+str(soma_v_init)+'_gpas'+str(gpas)+'_epas' +str(vpas)+'_V.txt' 
            zerobool = True
    elif plotvsl==True:
        dendlen = dendlens[i]
        folder = 'Ball-and-stick models/BAS_passive/Results/IStim/Soma%i/dendlen%i/denddiam'% (somasize,dendlen)+str(denddiam) +'/current_idur%i_iamp'% idur+str(iamp)+'/dtexp%i/' % dtexp
        ...
        if dendlen==0:
            somaonly_folder = 'Somaonly/pas/Results/IStim/Soma10/current_idur%i_iamp'% idur+str(iamp)+'/dtexp%i/' % dtexp
            infilename = somaonly_folder+'somaonly_cm'+str(cm)+'_idur%i_iamp'%idur+str(iamp)+'_Ra%_vinit'%Ra+str(soma_v_init)+'_gpas'%Ra+str(gpas)+'_epas' +str(vpas)+'_pas_V.txt' 
            zerobool = True
