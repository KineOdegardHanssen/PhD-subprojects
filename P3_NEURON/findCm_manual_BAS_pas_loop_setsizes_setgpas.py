...
folder = 'Results/IStim/Soma%i/dendlen%i/denddiam'% (somasize,dendlen)+str(denddiam) +'/current_idur%i_iamp'% idur+str(iamp)+'/dtexp%i/' % dtexp
outfilename = folder +'baspass_cms_idur%i_iamp' % idur+str(iamp)+'_Ra%i_gpas'%Ra+str(gpas)+'_vpas' +str(vpas)+'_Cm'
outfilename_tau = folder +'baspass_cms_idur%i_iamp' % idur+str(iamp)+'_Ra%i_gpas'%Ra+str(gpas)+'_vpas' +str(vpas)+'_tau'
outfilename_R = folder +'baspass_cms_idur%i_iamp' % idur+str(iamp)+'_Ra%i_gpas'%Ra+str(gpas)+'_vpas' +str(vpas)+'_Rin'
if long==True:
