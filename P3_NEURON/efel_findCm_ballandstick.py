...
if __name__ == '__main__':
    ...
    folder = 'Results/IStim/current_idur'+str(idur)+'_iamp'+str(iamp)+'/'
    outfilename_all = folder +'bas_varycm_idur%.1f_iamp'%idur+str(iamp)+'_Ra%i_vinit' %Ra+str(v_init)+'_Cm.txt' 
    plotname =  folder +'bas_varycm_idur%.1f_iamp'%idur+str(iamp)+'_Ra%i_vinit' %Ra+str(v_init)+'_Cm.png' 
    outname_all = open(outfilename_all,'w')
    for i in range(Ncm):
        cm = cms[i]
        filename = folder+'bas_cm'+str(cm)+'_idur%.1f_iamp'%idur+str(iamp)+'_Ra%i_vinit' %Ra+str(v_init)+'_V.txt' 
        outfilename = folder +'bas_cm'+str(cm)+'_idur%.1f_iamp'%idur+str(iamp)+'_Ra%i_vinit' %Ra+str(v_init)+'_Cm.txt' 
