...
if __name__ == '__main__':
    ...
    outfilename_Nspikes = outfolder+'somaonly_idur%i_cm'% idur+str(cm) +'_Nspikes_vs_iamp.txt'
    outfilename_APampl  = outfolder+'somaonly_idur%i_cm'% idur+str(cm)+'_APampl_vs_iamp.txt'
    outfilename_APdhw   = outfolder+'somaonly_idur%i_cm'% idur+str(cm)+'_APdurhalfwidth_vs_iamp.txt'
    plotname_Nspikes    = outfolder+'somaonly_idur%i_cm'% idur+str(cm)+'_Nspikes_vs_iamp.png'
    plotname_APampl     = outfolder+'somaonly_idur%i_cm'% idur+str(cm)+'_APampl_vs_iamp.png'
    plotname_APdhw      = outfolder+'somaonly_idur%i_cm'% idur+str(cm)+'_APdurhalfwidth_vs_iamp.png'
    # make files
    ...
    for j in range(Namps):
        ...
        filename = infolder+'somaonly_cm'+str(cm)+'_idur%i_iamp'%idur+str(iamps[j])+'_Ra'+str(Ra)+'_vinit'+str(v_init)+'_V.txt' 
