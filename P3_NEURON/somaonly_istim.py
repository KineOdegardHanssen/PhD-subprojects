...
if __name__ == '__main__':
    ...
    plotname = outfolder+'somaonly_varycm_idur%i_iamp'%idur+str(iamp)+'_Ra%i_vinit'%Ra+str(v_init)+'_V.png' 
    for cm in cms:
        print('cm:',cm)
        t, v = run_sim(cm, idur, iamp, idelay, v_init, tstart, tstop, Ra, testmodel)
        outfilename = outfolder+'somaonly_cm'+str(cm)+'_idur%i_iamp'%idur+str(iamp)+'_Ra%i_vinit' %Ra+str(v_init)+'_V.txt' 
