...
outfilename  = endlocation_out+'D_vs_d_better_rms_ljfactor'+str(ljfactor)+'_Nintervals%i.txt' % Nintervals
plotname     = endlocation_out+'D_vs_d_better_rms_ljfactor'+str(ljfactor)+'_Nintervals%i.png' % Nintervals
plotname_fit = endlocation_out+'D_vs_d_fit_better_rms_ljfactor'+str(ljfactor)+'_Nintervals%i.png' % Nintervals
indfilename  = endlocation_out+'D_vs_d_fitindices_better_rms_ljfactor'+str(ljfactor)+'_Nintervals%i.txt' % Nintervals
...
for i in range(N):
    ...
    infilename = endlocation_in+'diffusion'+filestext+'_nocut_better_rms_ljfactor'+str(ljfactor)+'_Nintervals%i.txt' % Nintervals
    metaname   = endlocation_in+'diffusion_metadata'+filestext+'_nocut_better_rms_ljfactor'+str(ljfactor)+'_Nintervals%i.txt' % Nintervals
...
plt.title('Diffusion constant $D$, dynamic %s, ljfactor %s' % (systemtype,str(ljfactor)))
plt.tight_layout()
