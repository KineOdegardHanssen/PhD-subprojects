...
endlocation_in = '/home/kine/Documents/Backup2_P2_PolymerMD/P2_PolymerMD/Planar_brush/Diffusion_bead_near_grid/Spacing'+str(spacing)+'/damp%i_diffseedLgv/Pure_bulk/Sigma_bead_' % damp+str(psigma) + '/'
...
for j in range(Nrms):
    ...
    for k in range(N_per_rms):
        ...
        #if max(zs_fortesting)>zhigh: # Don't need to test for unphysical stuff here
        #    continue
