...
foldername  = 'C:/Users/Kine/Documents/Projects_PhD/P2_PolymerMD/Planar_brush/Diffusion_bead_near_grid/Initial_configurations/Spacing%i/Sigma_bead_1/Hexagonal/' % spacing
outfilename = 'data.bead_wsubstr_hex_eq_N909_d%i_charge%i_mass1_file' % (spacing,charge)

infilename = 'data.hexatethered_substrate_N808_Nchains8_gridspacing%i_twofixed_charge%i_mass1_equilibrated' % (spacing, charge)
