...
if mass<1:
    outfilename = 'data.chaingrids_substrate_N%i_Nchains%i_Ly%i_gridspacing%i_twofixed_charge%i_mass%.5f' % (Nelem,M,L2,gridspacing,charge,mass)
else:
    outfilename = 'data.chaingrids_substrate_N%i_Nchains%i_Ly%i_gridspacing%i_twofixed_charge%i_mass%i' % (Nelem,M,L2,gridspacing,charge,mass)
