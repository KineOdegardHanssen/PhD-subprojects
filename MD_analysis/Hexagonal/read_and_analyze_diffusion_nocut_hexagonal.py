...
spacings = [3]#[25,50,75,100]#[7,8,10,15]#[3,4,5,6]#[1,1.25,1.5,2]#[2.5,3.5]
psigma   = 1
damp     = 10
...
for spacing in spacings:
    ...
    endlocation   = 'C:/Users/Kine/Documents/Projects_PhD/P2_PolymerMD/Planar_brush/Diffusion_bead_near_grid/Spacing'+str(spacing)+'/damp%i_diffseedLgv/' % damp +parentfolder+ 'Sigma_bead_' +str(psigma) + '/Hexagonal/Nocut/'
