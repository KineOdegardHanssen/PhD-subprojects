...
endlocation_base         = 'C:/Users/Kine/Documents/Projects_PhD/P2_PolymerMD/Planar_brush/Diffusion_bead_near_grid/Spacing'+str(spacing)+'/damp%i_diffseedLgv/Brush/Sigma_bead_' % damp+str(psigma) + '/'
endlocation              = endlocation_base +'Nocut/'
endlocation_in           = 'C:/Users/Kine/Documents/Projects_PhD/P2_PolymerMD/Planar_brush/Diffusion_bead_near_grid/Spacing'+str(spacing)+'/damp%i_diffseedLgv/Brush/Sigma_bead_' % damp+str(psigma) + '/ljfactor'+str(ljfactor)+'/'
filestext                = 'config'+str(confignrs[0])+'to'+str(confignrs[-1])
# Text files
outfilename_ds           = endlocation+'av_ds_'+filestext+'_nocut_ljfactor'+str(ljfactor)+'.txt'
outfilename_gamma        = endlocation+'zimportance_'+filestext+'_nocut_ljfactor'+str(ljfactor)+'.txt'
outfilename_sections     = endlocation+'sections_'+filestext+'_nocut_ljfactor'+str(ljfactor)+'.txt'
outfilename_maxz         = endlocation+'maxz_az_'+filestext+'_nocut_ljfactor'+str(ljfactor)+'.txt'
outfilename_dt           = endlocation+'dt_nocut_ljfactor'+str(ljfactor)+'.txt'
outfilename_alltrajs_z   = endlocation+'zs_all_ljfactor'+str(ljfactor)+'.txt'
outfilename_alltrajs_R2  = endlocation+'R2s_all_ljfactor'+str(ljfactor)+'.txt'
outfilename_skippedfiles = endlocation+'skippedfiles_ljfactor'+str(ljfactor)+'.txt'

# Plots
plotname             = endlocation+filestext+'_nocut_ljfactor'+str(ljfactor)+'.png'
plotname_all         = endlocation+'all_'+filestext+'_nocut_ljfactor'+str(ljfactor)+'.png'
plotname_gamma       = endlocation+'zimportance_'+filestext+'_nocut_ljfactor'+str(ljfactor)+'.png'
plotname_SI          = endlocation+'SI_'+filestext+'_nocut_ljfactor'+str(ljfactor)+'.png'
plotname_parallel_orthogonal = endlocation+'par_ort_'+filestext+'_nocut_ljfactor'+str(ljfactor)+'.png'
plotname_dx_dy_dz    = endlocation+'dx_dy_dz_'+filestext+'_nocut_ljfactor'+str(ljfactor)+'.png'
plotname_parallel    = endlocation+'par_'+filestext+'_nocut_ljfactor'+str(ljfactor)+'.png' 
plotname_orthogonal  = endlocation+'ort_'+filestext+'_nocut_ljfactor'+str(ljfactor)+'.png'
plotname_short_all   = endlocation+'short_all_'+filestext+'_nocut_ljfactor'+str(ljfactor)+'.png'
plotname_velocity    = endlocation+'velocity_'+filestext+'_nocut_ljfactor'+str(ljfactor)+'.png'
plotname_velocity_SI = endlocation+'velocity_SI_'+filestext+'_nocut_ljfactor'+str(ljfactor)+'.png'
plotname_velocity_sq = endlocation+'velocity_sq_'+filestext+'_nocut_ljfactor'+str(ljfactor)+'.png'
plotname_sectioned_average = endlocation+'sections_'+filestext+'_nocut_ljfactor'+str(ljfactor)+'.png'
plotname_sectioned_average_vs_steps = endlocation+'sections_steps_'+filestext+'_nocut_ljfactor'+str(ljfactor)+'.png'
plotname_traj_xy = endlocation+'traj_xy_config'+str(confignrs[-1])+'_nocut_ljfactor'+str(ljfactor)+'.png'
plotname_traj_xz = endlocation+'traj_xz_config'+str(confignrs[-1])+'_nocut_ljfactor'+str(ljfactor)+'.png'
plotname_traj_yz = endlocation+'traj_yz_config'+str(confignrs[-1])+'_nocut_ljfactor'+str(ljfactor)+'.png'
plotname_traj_xt = endlocation+'traj_xt_config'+str(confignrs[-1])+'_nocut_ljfactor'+str(ljfactor)+'.png'
plotname_traj_yt = endlocation+'traj_yt_config'+str(confignrs[-1])+'_nocut_ljfactor'+str(ljfactor)+'.png'
plotname_traj_zt = endlocation+'traj_zt_config'+str(confignrs[-1])+'_nocut_ljfactor'+str(ljfactor)+'.png'
plotname_th_hist = endlocation+'th_hist_'+filestext+'_nocut_ljfactor'+str(ljfactor)+'.png'
