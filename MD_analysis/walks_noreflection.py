...
filename_D = '2D_d'+str(d)+'_rsphere'+str(r_hardsphere)+'_Nsteps%i_Nreal%i_norefl_D.txt' %(Nsteps,Nreal)
filename_msd = '2D_d'+str(d)+'_rsphere'+str(r_hardsphere)+'_Nsteps%i_Nreal%i_norefl_msd.txt' %(Nsteps,Nreal) # Should I bother to write the raw data to file? It's not like I have a lot of data point.
