...
endlocation          = '/home/kine/Documents/Backup2_P2_PolymerMD/P2_PolymerMD/Planar_brush/Diffusion_bead_near_grid/Spacing'+str(spacing)+'/damp%i_diffseedLgv/Pure_bulk/Sigma_bead_' % damp+str(psigma) + '/'
filestext            = 'seed'+str(confignrs[0])+'to'+str(confignrs[-1])

# Text files
if long==False:
    infilename_ds       = endlocation+'av_ds_'+filestext+'.txt'
else:
    infilename_ds       = endlocation+'av_ds_'+filestext+'_long.txt'

# Plots
if long==False:
    plotname             = endlocation+'par_ort_beginning_'+filestext+'.png'
else:
    plotname             = endlocation+'par_ort_beginning_'+filestext+'_long.png'
