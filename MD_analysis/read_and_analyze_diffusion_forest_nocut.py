...
spacings = [3]#[25,50,75,100]#[7,8,10,15]#[3,4,5,6]
psigma   = 1
damp     = 10
...
for spacing in spacings:
    ...
    endlocation   = 'C:/Users/Kine/Documents/Projects_PhD/P2_PolymerMD/Planar_brush/Diffusion_forest/Spacing'+str(spacing)+'/Results/'
    if cutit==True:
