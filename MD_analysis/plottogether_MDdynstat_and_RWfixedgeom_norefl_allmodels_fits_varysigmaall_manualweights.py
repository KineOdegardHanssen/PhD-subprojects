...
weights_dsmall = 20
weights_dhigh = weights_dsmall/8.
...
if big==False:
    ### d
    plotname_d_dyn     = endlocation_static+'D_vs_d_dyn_norefl_rsphere'+str(rsphere)+'_allmodels_modelr_findsigma_fittomid_sigmafit_upperbounds1inf_manualweights.png'
    plotname_d_stat    = endlocation_static+'D_vs_d_stat_norefl_rsphere'+str(rsphere)+'_allmodels_modelr_findsigma_fittomid_sigmafit_upperbounds1inf_manualweights.png'
    plotname_d_f       = endlocation_static+'D_vs_d_f_norefl_rsphere'+str(rsphere)+'_allmodels_modelr_findsigma_fittomid_sigmafit_upperbounds1inf_manualweights.png'
    # perp:
    plotname_d_dyn_perp     = endlocation_static+'D_vs_d_dyn_norefl_rsphere'+str(rsphere)+'_allmodels_modelr_findsigma_perp_fittomid_sigmafit_upperbounds1inf_manualweights.png'
    plotname_d_stat_perp    = endlocation_static+'D_vs_d_stat_norefl_rsphere'+str(rsphere)+'_allmodels_modelr_findsigma_perp_fittomid_sigmafit_upperbounds1inf_manualweights.png'
    plotname_d_f_perp       = endlocation_static+'D_vs_d_f_norefl_rsphere'+str(rsphere)+'_allmodels_modelr_findsigma_perp_fittomid_sigmafit_upperbounds1inf_manualweights.png'
    plotname_cut_d = endlocation_static+'D_vs_d_dyn_vs_stat_vs_RWgeom_cut_norefl_rsphere'+str(rsphere)+'_modelr_findsigma_fittomid_sigmafit_upperbounds1inf_manualweights.png' ## Use this?
else:
    ### d 
    plotname_d_dyn     = endlocation_static+'D_vs_d_dyn_big_norefl_rsphere'+str(rsphere)+'_allmodels_modelr_findsigma_fittomid_sigmafit_upperbounds1inf_manualweights.png'
    plotname_d_stat    = endlocation_static+'D_vs_d_stat_big_norefl_rsphere'+str(rsphere)+'_allmodels_modelr_findsigma_fittomid_sigmafit_upperbounds1inf_manualweights.png'
    plotname_d_f       = endlocation_static+'D_vs_d_f_big_norefl_rsphere'+str(rsphere)+'_allmodels_modelr_findsigma_fittomid_sigmafit_upperbounds1inf_manualweights.png'
    # perp:
    plotname_d_dyn_perp     = endlocation_static+'D_vs_d_dyn_big_norefl_rsphere'+str(rsphere)+'_allmodels_modelr_findsigma_perp_fittomid_sigmafit_upperbounds1inf_manualweights.png'
    plotname_d_stat_perp    = endlocation_static+'D_vs_d_stat_big_norefl_rsphere'+str(rsphere)+'_allmodels_modelr_findsigma_perp_fittomid_sigmafit_upperbounds1inf_manualweights.png'
    plotname_d_f_perp       = endlocation_static+'D_vs_d_f_big_norefl_rsphere'+str(rsphere)+'_allmodels_modelr_findsigma_perp_fittomid_sigmafit_upperbounds1inf_manualweights.png'
    plotname_cut_d = endlocation_static+'D_vs_d_dyn_vs_stat_cut_vs_RWgeom_big_norefl_rsphere'+str(rsphere)+'_allmodels_modelr_findsigma_fittomid_sigmafit_upperbounds1inf_manualweights.png' ## Use this?
...
Nspacings2 = len(spacings_dyn)
fitweights = np.zeros(Nspacings2)

for i in range(Nspacings2):
    thisd = spacings_stat[i]
    if thisd<5: # Is this reasonable? Make larger?
        fitweights[i]= weights_dsmall
    else:
        fitweights[i]= weights_dhigh
...
sigma_op_rw          = popt[0]
popt, pcov           = curve_fit(ordered_packings, spacings_stat, Dparallel_stat, maxfev=thismaxfev,sigma=fitweights)
sigma_op_stat        = popt[0]
popt, pcov           = curve_fit(ordered_packings, spacings_dyn, Dparallel_dyn, p0=7, maxfev=thismaxfev,sigma=fitweights)
sigma_op_dyn         = popt[0]
popt, pcov           = curve_fit(ordered_packings, spacings_f, Dparallel_f, maxfev=thismaxfev)
sigma_op_f           = popt[0]
# Perp
popt, pcov           = curve_fit(ordered_packings, spacings_stat, Dzs_stat, maxfev=thismaxfev,sigma=fitweights)
sigma_op_stat_perp   = popt[0]
popt, pcov           = curve_fit(ordered_packings, spacings_dyn, Dzs_dyn, p0=7, maxfev=thismaxfev,sigma=fitweights)
...
sigma_hr_rw          = popt[0]
popt, pcov           = curve_fit(hyp_rev, spacings_stat, Dparallel_stat, maxfev=thismaxfev,sigma=fitweights)
sigma_hr_stat        = popt[0]
popt, pcov           = curve_fit(hyp_rev, spacings_dyn, Dparallel_dyn, p0=5, maxfev=thismaxfev,sigma=fitweights)
sigma_hr_dyn         = popt[0]
popt, pcov           = curve_fit(hyp_rev, spacings_f, Dparallel_f, maxfev=thismaxfev)
sigma_hr_f           = popt[0]
# Perp
popt, pcov           = curve_fit(hyp_rev, spacings_stat, Dzs_stat, maxfev=thismaxfev,sigma=fitweights)
sigma_hr_stat_perp   = popt[0]
popt, pcov           = curve_fit(hyp_rev, spacings_dyn, Dzs_dyn, p0=5, maxfev=thismaxfev,sigma=fitweights)
...
sigma_hc_rw          = popt[0]
popt, pcov           = curve_fit(het_cat, spacings_stat, Dparallel_stat,maxfev=thismaxfev,sigma=fitweights)
sigma_hc_stat        = popt[0]
popt, pcov           = curve_fit(het_cat, spacings_dyn, Dparallel_dyn, maxfev=thismaxfev,sigma=fitweights)
sigma_hc_dyn         = popt[0]
popt, pcov           = curve_fit(het_cat, spacings_f, Dparallel_f, maxfev=thismaxfev)
sigma_hc_f           = popt[0]
# Perp
popt, pcov           = curve_fit(het_cat, spacings_stat, Dzs_stat,maxfev=thismaxfev,sigma=fitweights)
sigma_hc_stat_perp   = popt[0]
popt, pcov           = curve_fit(het_cat, spacings_dyn, Dzs_dyn, maxfev=thismaxfev,sigma=fitweights)
...
sigma_rm_rw          = popt[0]
popt, pcov           = curve_fit(catex_resin_membr, spacings_stat, Dparallel_stat, maxfev=thismaxfev,sigma=fitweights)
sigma_rm_stat        = popt[0]
popt, pcov           = curve_fit(catex_resin_membr, spacings_dyn, Dparallel_dyn, maxfev=thismaxfev,sigma=fitweights)
sigma_rm_dyn         = popt[0]
popt, pcov           = curve_fit(catex_resin_membr, spacings_f, Dparallel_f, maxfev=thismaxfev)
sigma_rm_f           = popt[0]
#Perp
popt, pcov           = curve_fit(catex_resin_membr, spacings_stat, Dzs_stat, maxfev=thismaxfev,sigma=fitweights)
sigma_rm_stat_perp   = popt[0]
popt, pcov           = curve_fit(catex_resin_membr, spacings_dyn, Dzs_dyn, maxfev=thismaxfev,sigma=fitweights)
...
k_m1_rw            = popt[0]
sigma_m1_rw        = popt[1]
popt, pcov         = curve_fit(mymodel1, spacings_stat, Dparallel_stat, maxfev=thismaxfev, bounds=([0,-np.inf],[1,np.inf]),sigma=fitweights)
k_m1_stat          = popt[0]
sigma_m1_stat      = popt[1]
k_m1_stat_stdv     = pcov[0]
sigma_m1_stat_stdv = pcov[1]
popt, pcov         = curve_fit(mymodel1, spacings_dyn, Dparallel_dyn, maxfev=thismaxfev, bounds=([0,-np.inf],[1,np.inf]),sigma=fitweights)
k_m1_dyn           = popt[0]
sigma_m1_dyn       = popt[1]
k_m1_dyn_stdv      = pcov[0]
sigma_m1_dyn_stdv  = pcov[1]
...
sigma_m1_dyn_stdv  = pcov[1]
#Perp
popt, pcov              = curve_fit(mymodel1, spacings_stat, Dzs_stat, maxfev=thismaxfev, bounds=([0,-np.inf],[1,np.inf]),sigma=fitweights)
k_m1_stat_perp          = popt[0]
k_m1_stat_perp_stdv     = pcov[0]
sigma_m1_stat_perp      = popt[1]
sigma_m1_stat_perp_stdv = pcov[1]
popt, pcov              = curve_fit(mymodel1, spacings_dyn, Dzs_dyn, maxfev=thismaxfev, bounds=([0,-np.inf],[1,np.inf]),sigma=fitweights)
k_m1_dyn_perp           = popt[0]
k_m1_dyn_perp_stdv      = pcov[0]
sigma_m1_dyn_perp       = popt[1]
sigma_m1_dyn_perp_stdv  = pcov[1]
...
k_m2_rw            = popt[0]
sigma_m2_rw        = popt[1]
popt, pcov = curve_fit(mymodel2, spacings_stat, Dparallel_stat, maxfev=thismaxfev, bounds=([0,-np.inf],[1,np.inf]),sigma=fitweights)
k_m2_stat          = popt[0]
k_m2_stat_stdv     = pcov[0]
sigma_m2_stat      = popt[1]
sigma_m2_stat_stdv = pcov[1]
popt, pcov         = curve_fit(mymodel2, spacings_dyn, Dparallel_dyn, maxfev=thismaxfev, bounds=([0,-np.inf],[1,np.inf]),sigma=fitweights)
k_m2_dyn           = popt[0]
k_m2_dyn_stdv      = pcov[0]
sigma_m2_dyn       = popt[1]
sigma_m2_dyn_stdv  = pcov[1]
popt, pcov         = curve_fit(mymodel2, spacings_f, Dparallel_f, maxfev=thismaxfev, bounds=([0,-np.inf],[1,np.inf]))
k_m2_f             = popt[0]
sigma_m2_f         = popt[1]
#Perp
popt, pcov   = curve_fit(mymodel2, spacings_stat, Dzs_stat, maxfev=thismaxfev, bounds=([0,-np.inf],[1,np.inf]),sigma=fitweights)
k_m2_stat_perp          = popt[0]
k_m2_stat_perp_stdv     = pcov[0]
sigma_m2_stat_perp      = popt[1]
sigma_m2_stat_perp_stdv = pcov[1]
popt, pcov              = curve_fit(mymodel2, spacings_dyn, Dzs_dyn, maxfev=thismaxfev, bounds=([0,-np.inf],[1,np.inf]),sigma=fitweights)
k_m2_dyn_perp           = popt[0]
k_m2_dyn_perp_stdv      = pcov[0]
sigma_m2_dyn_perp       = popt[1]
sigma_m2_dyn_perp_stdv  = pcov[1]
...
k_m3_rw              = popt[0]
sigma_m3_rw          = popt[1]
popt, pcov = curve_fit(mymodel3, spacings_stat, Dparallel_stat, maxfev=thismaxfev, bounds=([0,-np.inf],[1,np.inf]),sigma=fitweights)
k_m3_stat            = popt[0]
k_m3_stat_stdv       = pcov[0]
sigma_m3_stat        = popt[1]
sigma_m3_stat_stdv   = pcov[1]
popt, pcov           = curve_fit(mymodel3, spacings_dyn, Dparallel_dyn, maxfev=thismaxfev, bounds=([0,-np.inf],[1,np.inf]),sigma=fitweights)
k_m3_dyn             = popt[0]
k_m3_dyn_stdv        = pcov[0]
sigma_m3_dyn         = popt[1]
sigma_m3_dyn_stdv    = pcov[1]
popt, pcov           = curve_fit(mymodel3, spacings_f, Dparallel_f, maxfev=thismaxfev, bounds=([0,-np.inf],[1,np.inf]))
k_m3_f               = popt[0]
sigma_m3_f           = popt[1]
#Perp
popt, pcov              = curve_fit(mymodel3, spacings_stat, Dzs_stat, maxfev=thismaxfev, bounds=([0,-np.inf],[1,np.inf]),sigma=fitweights)
k_m3_stat_perp          = popt[0]
k_m3_stat_perp_stdv     = pcov[0]
sigma_m3_stat_perp      = popt[1]
sigma_m3_stat_perp_stdv = pcov[1]
popt, pcov              = curve_fit(mymodel3, spacings_dyn, Dzs_dyn, maxfev=thismaxfev, bounds=([0,-np.inf],[1,np.inf]),sigma=fitweights)
k_m3_dyn_perp           = popt[0]
k_m3_dyn_perp_stdv      = pcov[0]
sigma_m3_dyn_perp       = popt[1]
sigma_m3_dyn_perp_stdv  = pcov[1]
...
f_m4_rw              = popt[1]
sigma_m4_rw          = popt[2]
popt, pcov = curve_fit(mymodel4, spacings_stat, Dparallel_stat, maxfev=thismaxfev, bounds=([0,-np.inf,-np.inf],[1,np.inf,np.inf]),sigma=fitweights)
k_m4_stat            = popt[0]
f_m4_stat            = popt[1]
sigma_m4_stat        = popt[2]
k_m4_stat_stdv       = pcov[0]
f_m4_stat_stdv       = pcov[1]
sigma_m4_stat_stdv   = pcov[2]
popt, pcov           = curve_fit(mymodel4, spacings_dyn, Dparallel_dyn, maxfev=thismaxfev, bounds=([0,-np.inf,-np.inf],[1,np.inf,np.inf]),sigma=fitweights)
k_m4_dyn             = popt[0]
f_m4_dyn             = popt[1]
sigma_m4_dyn         = popt[2]
k_m4_dyn_stdv        = pcov[0]
f_m4_dyn_stdv        = pcov[1]
sigma_m4_dyn_stdv    = pcov[2]
popt, pcov           = curve_fit(mymodel4, spacings_f, Dparallel_f, maxfev=thismaxfev, bounds=([0,-np.inf,-np.inf],[1,np.inf,np.inf]))
k_m4_f               = popt[0]
f_m4_f               = popt[1]
sigma_m4_f           = popt[2]
#Perp
popt, pcov              = curve_fit(mymodel4, spacings_stat, Dzs_stat, maxfev=thismaxfev, bounds=([0,-np.inf,-np.inf],[1,np.inf,np.inf]),sigma=fitweights)
k_m4_stat_perp          = popt[0]
f_m4_stat_perp          = popt[1]
sigma_m4_stat_perp      = popt[2]
k_m4_stat_perp_stdv     = pcov[0]
f_m4_stat_perp_stdv     = pcov[1]
sigma_m4_stat_perp_stdv = pcov[2]
popt, pcov              = curve_fit(mymodel4, spacings_dyn, Dzs_dyn, maxfev=thismaxfev, bounds=([0,-np.inf,-np.inf],[1,np.inf,np.inf]),sigma=fitweights)
k_m4_dyn_perp           = popt[0]
f_m4_dyn_perp           = popt[1]
sigma_m4_dyn_perp       = popt[2]
k_m4_dyn_perp_stdv      = pcov[0]
f_m4_dyn_perp_stdv      = pcov[1]
sigma_m4_dyn_perp_stdv  = pcov[2]
...
f_m5_rw            = popt[1]
sigma_m5_rw        = popt[2]
popt, pcov         = curve_fit(mymodel5, spacings_stat, Dparallel_stat, maxfev=1000000, bounds=([0,-np.inf,-np.inf],[1,np.inf,np.inf]),sigma=fitweights)
k_m5_stat          = popt[0]
f_m5_stat          = popt[1]
sigma_m5_stat      = popt[2]
k_m5_stat_stdv     = pcov[0]
f_m5_stat_stdv     = pcov[1]
sigma_m5_stat_stdv = pcov[2]
popt, pcov         = curve_fit(mymodel5, spacings_dyn, Dparallel_dyn, maxfev=1000000, bounds=([0,-np.inf,-np.inf],[1,np.inf,np.inf]),sigma=fitweights)
k_m5_dyn           = popt[0]
f_m5_dyn           = popt[1]
sigma_m5_dyn       = popt[2]
k_m5_dyn_stdv      = pcov[0]
f_m5_dyn_stdv      = pcov[1]
sigma_m5_dyn_stdv  = pcov[2]
popt, pcov         = curve_fit(mymodel5, spacings_f, Dparallel_f, maxfev=1000000, bounds=([0,-np.inf,-np.inf],[1,np.inf,np.inf]))
k_m5_f             = popt[0]
f_m5_f             = popt[1]
sigma_m5_f         = popt[2]
#Perp
popt, pcov              = curve_fit(mymodel5, spacings_stat, Dzs_stat, maxfev=1000000, bounds=([0,-np.inf,-np.inf],[1,np.inf,np.inf]),sigma=fitweights)
k_m5_stat_perp          = popt[0]
f_m5_stat_perp          = popt[1]
sigma_m5_stat_perp      = popt[2]
k_m5_stat_perp_stdv     = pcov[0]
f_m5_stat_perp_stdv     = pcov[1]
sigma_m5_stat_perp_stdv = pcov[2]
popt, pcov              = curve_fit(mymodel5, spacings_dyn, Dzs_dyn, maxfev=1000000, bounds=([0,-np.inf,-np.inf],[1,np.inf,np.inf]),sigma=fitweights)
k_m5_dyn_perp           = popt[0]
f_m5_dyn_perp           = popt[1]
sigma_m5_dyn_perp       = popt[2]
k_m5_dyn_perp_stdv      = pcov[0]
f_m5_dyn_perp_stdv      = pcov[1]
sigma_m5_dyn_perp_stdv  = pcov[2]
...
k_m6_rw            = popt[0]
sigma_m6_rw        = popt[1]
popt, pcov         = curve_fit(mymodel6, spacings_stat, Dparallel_stat, maxfev=thismaxfev,sigma=fitweights)#, bounds=(0,np.inf))
k_m6_stat          = popt[0]
k_m6_stat_stdv     = pcov[0]
sigma_m6_stat      = popt[1]
sigma_m6_stat_stdv = pcov[1]
popt, pcov         = curve_fit(mymodel6, spacings_dyn, Dparallel_dyn, maxfev=thismaxfev,sigma=fitweights)#, bounds=(0,np.inf))
k_m6_dyn           = popt[0]
k_m6_dyn_stdv      = pcov[0]
sigma_m6_dyn       = popt[1]
sigma_m6_dyn_stdv  = pcov[1]
popt, pcov         = curve_fit(mymodel6, spacings_f, Dparallel_f, maxfev=thismaxfev)#, bounds=(0,np.inf))
k_m6_f             = popt[0]
sigma_m6_f         = popt[1]
#Perp
popt, pcov              = curve_fit(mymodel6, spacings_stat, Dzs_stat, maxfev=thismaxfev,sigma=fitweights)#, bounds=(0,np.inf))
k_m6_stat_perp          = popt[0]
k_m6_stat_perp_stdv     = pcov[0]
sigma_m6_stat_perp      = popt[1]
sigma_m6_stat_perp_stdv = pcov[1]
popt, pcov              = curve_fit(mymodel6, spacings_dyn, Dzs_dyn, maxfev=thismaxfev,sigma=fitweights)#, bounds=(0,np.inf))
k_m6_dyn_perp           = popt[0]
k_m6_dyn_perp_stdv      = pcov[0]
sigma_m6_dyn_perp       = popt[1]
sigma_m6_dyn_perp_stdv  = pcov[1]
...
l_p1_rw          = popt[1]
n_p1_rw          = popt[2]
popt, pcov       = curve_fit(powerlaw1, spacings_stat, Dparallel_stat, maxfev=thismaxfev,sigma=fitweights)#, bounds=(0,1))
k_p1_stat        = popt[0]
l_p1_stat        = popt[1]
n_p1_stat        = popt[2]
k_p1_stat_stdv   = pcov[0]
l_p1_stat_stdv   = pcov[1]
n_p1_stat_stdv   = pcov[2]
popt, pcov       = curve_fit(powerlaw1, spacings_dyn, Dparallel_dyn, maxfev=thismaxfev,sigma=fitweights)#, bounds=(0,1))
k_p1_dyn         = popt[0]
l_p1_dyn         = popt[1]
n_p1_dyn         = popt[2]
k_p1_dyn_stdv    = pcov[0]
l_p1_dyn_stdv    = pcov[1]
n_p1_dyn_stdv    = pcov[2]
popt, pcov       = curve_fit(powerlaw1, spacings_f, Dparallel_f, maxfev=thismaxfev)#, bounds=(0,1))
k_p1_f           = popt[0]
l_p1_f           = popt[1]
n_p1_f           = popt[2]
#Perp
popt, pcov          = curve_fit(powerlaw1, spacings_stat, Dzs_stat, maxfev=thismaxfev,sigma=fitweights)#, bounds=(0,1))
k_p1_stat_perp      = popt[0]
l_p1_stat_perp      = popt[1]
n_p1_stat_perp      = popt[2]
k_p1_stat_perp_stdv = pcov[0]
l_p1_stat_perp_stdv = pcov[1]
n_p1_stat_perp_stdv = pcov[2]
popt, pcov          = curve_fit(powerlaw1, spacings_dyn, Dzs_dyn, maxfev=thismaxfev,sigma=fitweights)#, bounds=(0,1))
k_p1_dyn_perp       = popt[0]
l_p1_dyn_perp       = popt[1]
n_p1_dyn_perp       = popt[2]
k_p1_dyn_perp_stdv  = pcov[0]
l_p1_dyn_perp_stdv  = pcov[1]
n_p1_dyn_perp_stdv  = pcov[2]
...
line1, = ax.plot(fitds,Ds_rm_stat, '--,', label=r'Cation-exchange resin mem¨brane') 
line1.set_dashes([2, 2, 10, 2])  # 2pt line, 2pt break, 10pt line, 2pt break
# Add more plotting! # Need to beware of negative porosity for some!
plt.xlabel(r'$d$ (nm)')
plt.ylabel(r'$D/D_{\mathregular{bulk}}$', fontsize=12)
...
ax.plot(fitds,Ds_m4_f, '-.', label=r'Custom model 4')
...
ax.plot(fitds,Ds_m4_f_perp, '-.', label=r'Custom model 4')
