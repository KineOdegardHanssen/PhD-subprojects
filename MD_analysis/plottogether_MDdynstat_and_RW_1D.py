...
## Files to write to
if big==False:
    plotname     = endlocation_static+'D_graftdens_dyn_vs_stat_vs_RW_1D.png'
    plotname_cut = endlocation_static+'D_graftdens_dyn_vs_stat_vs_RW_1D_cut.png' ## Use this?
else:
    plotname     = endlocation_static+'D_graftdens_dyn_vs_stat_vs_RW_1D_big.png'
    plotname_cut = endlocation_static+'D_graftdens_dyn_vs_stat_cut_vs_RW_1D_big.png' ## Use this?
...
Nreal    = 100000
folder   = 'C:/Users/Kine/Documents/Projects_PhD/P2_PolymerMD/Randomwalk_biased/1D/'
infilename_Ddbulk = folder+'D_vs_hitprobs_Nsteps%i_Nreal%i_1D_Ddbulk.txt' %(Nsteps,Nreal)
...
plt.plot(phit,DRW, color='b', label='Random walk, 1D')
