...
outfolder      = basepath + 'D_vs_d/Brush/Sigma_bead_'+str(psigma)+'/'
outfilename    = outfolder + 'D_from_vacf_vs_d_dynamic.txt'
plotname       = outfolder + 'D_from_vacf_vs_d_dynamic.png'
plotname_short = outfolder + 'D_from_vacf_vs_d_dynamic_short.png'
...
for i in range(Nd):
    spacing = spacings[i]
    endlocation = basepath + 'Spacing'+str(spacing)+'/damp%i_diffseedLgv/Brush/Sigma_bead_' % damp+str(psigma) + '/'
    # In-file:
    infilename  = endlocation+'Dvacf_'+filestext
