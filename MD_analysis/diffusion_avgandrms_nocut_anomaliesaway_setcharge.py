...
endlocation_in = '/home/kine/Documents/Backup2_P2_PolymerMD/P2_PolymerMD/Planar_brush/Diffusion_bead_near_grid/Spacing'+str(spacing)+'/damp%i_diffseedLgv/Brush/Sigma_bead_' % damp + str(psigma) + '/Charge'+str(charge)+'/'
...
for j in range(Nrms):
    ...
    #print('----------------------------------')
    #print(' averageR2s_SI:', averageR2s_SI)
    #print('times_single_real',times_single_real)
    #print('startindex_R:',startindex_R)
    #print('endindex_R:',endindex_R)
    # Insert interval
