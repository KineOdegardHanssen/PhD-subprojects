...
endlocation          = 'C:/Users/Kine/Documents/Projects_PhD/P2_PolymerMD/Planar_brush/Diffusion_bead_near_grid/Spacing'+str(spacing)+'/damp%i_diffseedLgv/Brush/Sigma_bead_' % damp+str(psigma) + '/Nocut/'
filestext            = 'config'+str(confignrs[0])+'to'+str(confignrs[-1])

# Text files
infilename_ds       = endlocation+'av_ds_'+filestext+'_nocut_ljfactor'+str(ljfactor)+'.txt'

# Plots
plotname             = endlocation+'par_ort_beginning_'+filestext+'_nocut_ljfactor'+str(ljfactor)+'.png'
