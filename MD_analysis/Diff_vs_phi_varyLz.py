...
## Filenames
# In-files
basepath     = 'C:/Users/Kine/Documents/Projects_PhD/P2_PolymerMD/Planar_brush/'
...
phifilen_ws  = basepath + 'd_vs_phi_wsubstrate_varyLz.txt'
phifilen_oc  = basepath + 'd_vs_phi_withoutsubstrate_varyLz.txt'
outlocation  = mainlocation + 'D_vs_phi_varyLz/'

# Out-files
outfile               = outlocation + 'D_vs_phi_varyLz.txt'
plotname_block_oc     = outlocation + 'D_vs_phi_dyn_nocut_donlychains_block_varyLz'
plotname_bead_oc      = outlocation + 'D_vs_phi_dyn_nocut_donlychains_bead_varyLz'
plotname_block_ws     = outlocation + 'D_vs_phi_dyn_nocut_withsubstrate_block_varyLz'
plotname_bead_ws      = outlocation + 'D_vs_phi_dyn_nocut_withsubstrate_bead_varyLz'
plotname_block_oc_emp = outlocation + 'D_vs_phi_dyn_nocut_donlychains_block_empirical_varyLz'
plotname_bead_oc_emp  = outlocation + 'D_vs_phi_dyn_nocut_donlychains_bead_empirical_varyLz'
plotname_block_ws_emp = outlocation + 'D_vs_phi_dyn_nocut_withsubstrate_block_empirical_varyLz'
plotname_bead_ws_emp  = outlocation + 'D_vs_phi_dyn_nocut_withsubstrate_bead_empirical_varyLz'
plotname_notheory     = outlocation + 'D_vs_phi_dyn_nocut_donlychains_bead_bare_varyLz'
plotname_models       = outlocation + 'D_vs_phi_models'
parameters_empirical  = outlocation + 'parameters_empirical_varyLz.txt'
...
# Testing:
print('d_test:', d_test)
print('phi_bead_ws:', phi_bead_ws)
print('DRs:', DRs)

for i in range(len(d_test)):
    print('d:', d_test[i], '; phi:', phi_bead_ws[i], '; D_R:', DRs[i])

plt.figure(figsize=(6,5))
plt.plot(phi_bead_ws, DRs, 'o', label=r'$D$')
plt.plot(phi_bead_ws, Dzs, 'o', label=r'$D_\perp$')
plt.plot(phi_bead_ws, Dparallel, 'o', label=r'$D_\parallel$')
plt.xlabel(r'Porosity $\phi$ (bead, substr.)')
plt.ylabel(r'Diffusion constant $D$')
plt.title(r'$D$ vs $\phi$, bead, substr.')
plt.tight_layout()
...
plt.legend(loc='upper left')
plt.ticklabel_format(style='sci', axis='y', scilimits=(0,0))
plt.savefig(plotname_notheory)


plt.figure(figsize=(6,5))
plt.plot(d_test, DRs, label=r'$D$')
plt.plot(d_test, Dzs, label=r'$D_\perp$')
plt.plot(d_test, Dparallel, label=r'$D_\parallel$')
plt.xlabel(r'Porosity $\phi$ (bead, substr.)')
plt.ylabel(r'Diffusion constant $D$')
plt.title(r'$D$ vs $d$, bead, for testing')
plt.tight_layout()
plt.legend(loc='upper left')
plt.ticklabel_format(style='sci', axis='y', scilimits=(0,0))
#plt.axis([0, xmax_plot, 0, max(dR2[0:xmax_plot])])
