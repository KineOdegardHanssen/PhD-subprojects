...
if big==False:
    ### d
    plotname_d_dyn     = endlocation_static+'D_vs_d_dyn_norefl_rsphere'+str(rsphere)+'_allmodels_modelr_findsigma_fittomid_manualweights.png'
    plotname_d_stat    = endlocation_static+'D_vs_d_stat_norefl_rsphere'+str(rsphere)+'_allmodels_modelr_findsigma_fittomid_manualweights.png'
    plotname_d_f       = endlocation_static+'D_vs_d_f_norefl_rsphere'+str(rsphere)+'_allmodels_modelr_findsigma_fittomid_manualweights.png'
    # perp:
    plotname_d_dyn_perp     = endlocation_static+'D_vs_d_dyn_norefl_rsphere'+str(rsphere)+'_allmodels_modelr_findsigma_perp_fittomid_manualweights.png'
    plotname_d_stat_perp    = endlocation_static+'D_vs_d_stat_norefl_rsphere'+str(rsphere)+'_allmodels_modelr_findsigma_perp_fittomid_manualweights.png'
    plotname_d_f_perp       = endlocation_static+'D_vs_d_f_norefl_rsphere'+str(rsphere)+'_allmodels_modelr_findsigma_perp_fittomid_manualweights.png'
    plotname_cut_d = endlocation_static+'D_vs_d_dyn_vs_stat_vs_RWgeom_cut_norefl_rsphere'+str(rsphere)+'_modelr_findsigma_fittomid_manualweights.png' ## Use this?
else:
    ### d 
    plotname_d_dyn     = endlocation_static+'D_vs_d_dyn_big_norefl_rsphere'+str(rsphere)+'_allmodels_modelr_findsigma_fittomid_manualweights.png'
    plotname_d_stat    = endlocation_static+'D_vs_d_stat_big_norefl_rsphere'+str(rsphere)+'_allmodels_modelr_findsigma_fittomid_manualweights.png'
    plotname_d_f       = endlocation_static+'D_vs_d_f_big_norefl_rsphere'+str(rsphere)+'_allmodels_modelr_findsigma_fittomid_manualweights.png'
    # perp:
    plotname_d_dyn_perp     = endlocation_static+'D_vs_d_dyn_big_norefl_rsphere'+str(rsphere)+'_allmodels_modelr_findsigma_perp_fittomid_manualweights.png'
    plotname_d_stat_perp    = endlocation_static+'D_vs_d_stat_big_norefl_rsphere'+str(rsphere)+'_allmodels_modelr_findsigma_perp_fittomid_manualweights.png'
    plotname_d_f_perp       = endlocation_static+'D_vs_d_f_big_norefl_rsphere'+str(rsphere)+'_allmodels_modelr_findsigma_perp_fittomid_manualweights.png'
    plotname_cut_d = endlocation_static+'D_vs_d_dyn_vs_stat_cut_vs_RWgeom_big_norefl_rsphere'+str(rsphere)+'_allmodels_modelr_findsigma_fittomid_manualweights.png' ## Use this?
...
sigma_nm_rw          = popt[0]
popt, pcov           = curve_fit(notmonosph, spacings_stat, Dparallel_stat, p0=0.5, maxfev=thismaxfev,sigma=fitweights)
sigma_nm_stat        = popt[0]
popt, pcov           = curve_fit(notmonosph, spacings_dyn, Dparallel_dyn, p0=0.5, maxfev=thismaxfev,sigma=fitweights)
sigma_nm_dyn         = popt[0]
...
# My models:
### mymodel1(d,k)
popt, pcov       = curve_fit(mymodel1, spacings_rw, DRW, maxfev=thismaxfev, bounds=(0,1))
k_m1_rw          = popt[0]
popt, pcov       = curve_fit(mymodel1, spacings_stat, Dparallel_stat, maxfev=thismaxfev, bounds=(0,1),sigma=fitweights)
k_m1_stat        = popt[0]
k_m1_stat_stdv   = pcov[0]
popt, pcov       = curve_fit(mymodel1, spacings_dyn, Dparallel_dyn, maxfev=thismaxfev, bounds=(0,1),sigma=fitweights)
k_m1_dyn         = popt[0]
popt, pcov       = curve_fit(mymodel1, spacings_f, Dparallel_f, maxfev=thismaxfev, bounds=(0,1))
k_m1_f           = popt[0]
k_m1_dyn_stdv   = pcov[0]
#Perp
popt, pcov          = curve_fit(mymodel1, spacings_stat, Dzs_stat, maxfev=thismaxfev, bounds=(0,1),sigma=fitweights)
k_m1_stat_perp      = popt[0]
k_m1_stat_perp_stdv = pcov[0]
popt, pcov          = curve_fit(mymodel1, spacings_dyn, Dzs_dyn, maxfev=thismaxfev, bounds=(0,1),sigma=fitweights)
k_m1_dyn_perp       = popt[0]
k_m1_dyn_perp_stdv  = pcov[0]
popt, pcov          = curve_fit(mymodel1, spacings_f, Dzs_f, maxfev=thismaxfev, bounds=(0,1))
k_m1_f_perp         = popt[0]
...
### mymodel2(d,k)
popt, pcov       = curve_fit(mymodel2, spacings_rw, DRW, maxfev=thismaxfev, bounds=(0,np.inf))
k_m2_rw          = popt[0]
popt, pcov       = curve_fit(mymodel2, spacings_stat, Dparallel_stat, maxfev=thismaxfev, bounds=(0,np.inf),sigma=fitweights)
k_m2_stat        = popt[0]
k_m2_stat_stdv   = pcov[0]
popt, pcov       = curve_fit(mymodel2, spacings_dyn, Dparallel_dyn, maxfev=thismaxfev, bounds=(0,np.inf),sigma=fitweights)
k_m2_dyn         = popt[0]
k_m2_dyn_stdv    = pcov[0]
popt, pcov       = curve_fit(mymodel2, spacings_f, Dparallel_f, maxfev=thismaxfev, bounds=(0,np.inf))
k_m2_f           = popt[0]
#Perp
popt, pcov          = curve_fit(mymodel2, spacings_stat, Dzs_stat, maxfev=thismaxfev, bounds=(0,np.inf),sigma=fitweights)
k_m2_stat_perp      = popt[0]
k_m2_stat_perp_stdv = pcov[0]
popt, pcov          = curve_fit(mymodel2, spacings_dyn, Dzs_dyn, maxfev=thismaxfev, bounds=(0,np.inf),sigma=fitweights)
k_m2_dyn_perp       = popt[0]
k_m2_dyn_perp_stdv  = pcov[0]
popt, pcov          = curve_fit(mymodel2, spacings_f, Dzs_f, maxfev=thismaxfev, bounds=(0,np.inf))
k_m2_f_perp         = popt[0]
...
### mymodel3(d,k)
popt, pcov       = curve_fit(mymodel3, spacings_rw, DRW, maxfev=thismaxfev, bounds=(0,np.inf))
k_m3_rw          = popt[0]
popt, pcov       = curve_fit(mymodel3, spacings_stat, Dparallel_stat, maxfev=thismaxfev, bounds=(0,1),sigma=fitweights)
k_m3_stat        = popt[0]
k_m3_stat_stdv   = pcov[0]
popt, pcov       = curve_fit(mymodel3, spacings_dyn, Dparallel_dyn, maxfev=thismaxfev, bounds=(0,1),sigma=fitweights)
k_m3_dyn         = popt[0]
k_m3_dyn_stdv    = pcov[0]
popt, pcov       = curve_fit(mymodel3, spacings_f, Dparallel_f, maxfev=thismaxfev, bounds=(0,1))
k_m3_f           = popt[0]
#Perp
popt, pcov          = curve_fit(mymodel3, spacings_stat, Dzs_stat, maxfev=thismaxfev, bounds=(0,1),sigma=fitweights)
k_m3_stat_perp      = popt[0]
k_m3_stat_perp_stdv = pcov[0]
popt, pcov          = curve_fit(mymodel3, spacings_dyn, Dzs_dyn, maxfev=thismaxfev, bounds=(0,1),sigma=fitweights)
k_m3_dyn_perp       = popt[0]
k_m3_dyn_perp_stdv  = pcov[0]
popt, pcov          = curve_fit(mymodel3, spacings_f, Dzs_f, maxfev=thismaxfev, bounds=(0,1))
k_m3_f_perp         = popt[0]
...
### mymodel4(d,k,f)
popt, pcov       = curve_fit(mymodel4, spacings_rw, DRW, maxfev=thismaxfev, bounds=(0,1))
k_m4_rw          = popt[0]
f_m4_rw          = popt[1]
popt, pcov       = curve_fit(mymodel4, spacings_stat, Dparallel_stat, maxfev=thismaxfev, bounds=(0,1),sigma=fitweights)
k_m4_stat        = popt[0]
f_m4_stat        = popt[1]
k_m4_stat_stdv   = pcov[0]
f_m4_stat_stdv   = pcov[1]
popt, pcov       = curve_fit(mymodel4, spacings_dyn, Dparallel_dyn, maxfev=thismaxfev, bounds=(0,1),sigma=fitweights)
k_m4_dyn         = popt[0]
f_m4_dyn         = popt[1]
k_m4_dyn_stdv    = pcov[0]
f_m4_dyn_stdv    = pcov[1]
popt, pcov       = curve_fit(mymodel4, spacings_f, Dparallel_f, maxfev=thismaxfev, bounds=(0,1))
k_m4_f           = popt[0]
f_m4_f           = popt[1]
#Perp
popt, pcov          = curve_fit(mymodel4, spacings_stat, Dzs_stat, maxfev=thismaxfev, bounds=(0,1),sigma=fitweights)
k_m4_stat_perp      = popt[0]
f_m4_stat_perp      = popt[1]
k_m4_stat_perp_stdv = pcov[0]
f_m4_stat_perp_stdv = pcov[1]
popt, pcov          = curve_fit(mymodel4, spacings_dyn, Dzs_dyn, maxfev=thismaxfev, bounds=(0,1),sigma=fitweights)
k_m4_dyn_perp       = popt[0]
f_m4_dyn_perp       = popt[1]
k_m4_dyn_perp_stdv  = pcov[0]
f_m4_dyn_perp_stdv  = pcov[1]
popt, pcov          = curve_fit(mymodel4, spacings_f, Dzs_f, maxfev=thismaxfev, bounds=(0,1))
k_m4_f_perp         = popt[0]
f_m4_f_perp         = popt[1]
...
#popt, pcov       = curve_fit(mymodel5, spacings_rw, DRW, maxfev=1000000)
#k_m5_rw          = popt[0]
#f_m5_rw          = popt[1]
popt, pcov       = curve_fit(mymodel5, spacings_stat, Dparallel_stat, maxfev=1000000,sigma=fitweights)
k_m5_stat        = popt[0]
f_m5_stat        = popt[1]
k_m5_stat_stdv   = pcov[0]
f_m5_stat_stdv   = pcov[1]
popt, pcov       = curve_fit(mymodel5, spacings_dyn, Dparallel_dyn, maxfev=1000000,sigma=fitweights)
k_m5_dyn         = popt[0]
f_m5_dyn         = popt[1]
k_m5_dyn_stdv    = pcov[0]
f_m5_dyn_stdv    = pcov[1]
popt, pcov       = curve_fit(mymodel5, spacings_f, Dparallel_f, maxfev=1000000)
k_m5_f           = popt[0]
f_m5_f           = popt[1]
#Perp
popt, pcov          = curve_fit(mymodel5, spacings_stat, Dzs_stat, maxfev=1000000,sigma=fitweights)
k_m5_stat_perp      = popt[0]
f_m5_stat_perp      = popt[1]
k_m5_stat_perp_stdv = pcov[0]
f_m5_stat_perp_stdv = pcov[1]
popt, pcov          = curve_fit(mymodel5, spacings_dyn, Dzs_dyn, maxfev=1000000,sigma=fitweights)
k_m5_dyn_perp       = popt[0]
f_m5_dyn_perp       = popt[1]
k_m5_dyn_perp_stdv  = pcov[0]
f_m5_dyn_perp_stdv  = pcov[1]
popt, pcov          = curve_fit(mymodel5, spacings_f, Dzs_f, maxfev=1000000)
k_m5_f_perp         = popt[0]
f_m5_f_perp         = popt[1]
