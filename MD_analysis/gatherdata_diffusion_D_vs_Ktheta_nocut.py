...
endlocation_out = 'C:/Users/Kine/Documents/Projects_PhD/P2_PolymerMD/Planar_brush/Diffusion_bead_near_grid/D_vs_Ktheta/Spacing'+str(spacing)+'/Sigma_bead_' +str(psigma) + '/Nocut/'
...
for i in range(N):
    Ktheta = Kthetas[i]
    endlocation_in = 'C:/Users/Kine/Documents/Projects_PhD/P2_PolymerMD/Planar_brush/Diffusion_bead_near_grid/Spacing'+str(spacing)+'/damp%i_diffseedLgv/' % damp +parentfolder+ 'Sigma_bead_' +str(psigma) + '/VaryKtheta/Ktheta'+str(Ktheta)+'/Nocut/'
...
#plt.errorbar(Kthetas, DRs, yerr=DRs_stdv, capsize=2, fmt='none', label=r'$D_R$')
