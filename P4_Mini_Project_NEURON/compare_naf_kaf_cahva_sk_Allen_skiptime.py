...
ax3.set_title(r'Duration at %i mV' %spikedurat,fontsize=18)
...
plotname = outfolder+'compare_properties_naf_kaf_CaHVA_SK_Allen_skiptime'+str(skiptime)+'_commonprops.png'
...
# ampl
filename_ampl_base     = 'somaHjorth_idur%i_varyiamp'% (idur)+'_manual_cm'+str(cm)+'_Ampl_vs_I_s'+str(skiptime)+'.txt'
filename_ampl_CaHVA    = 'somaHjorth_idur%i_varyiamp'% (idur)+'_manual_cm'+str(cm)+namestring1+'_Ampl_vs_I_s'+str(skiptime)+'.txt'
filename_ampl_CaHVA_SK = 'somaHjorth_idur%i_varyiamp'% (idur)+'_manual_cm'+str(cm)+namestring2+'_Ampl_vs_I_s'+str(skiptime)+'.txt'
# dur
filename_dur_base     = 'somaHjorth_idur%i_varyiamp'% (idur)+'_manual_cm'+str(cm)+'_sdurat%s' % str(spikedurat)+'_vs_I_s'+str(skiptime)+'.txt'
filename_dur_CaHVA    = 'somaHjorth_idur%i_varyiamp'% (idur)+'_manual_cm'+str(cm)+namestring1+'_sdurat%s_vs_I_s' % str(spikedurat)+str(skiptime)+'.txt'
filename_dur_CaHVA_SK = 'somaHjorth_idur%i_varyiamp'% (idur)+'_manual_cm'+str(cm)+namestring2+'_sdurat%s_vs_I_s' % str(spikedurat)+str(skiptime)+'.txt'
# Gathering
filenames_Nspikes = [filename_Nspikes_base,filename_Nspikes_CaHVA,filename_Nspikes_CaHVA_SK]
filenames_ampl    = [filename_ampl_base,filename_ampl_CaHVA,filename_ampl_CaHVA_SK]
filenames_dur     = [filename_dur_base,filename_dur_CaHVA,filename_dur_CaHVA_SK]
...
for i in range(Nmodels):
    ...
    infilename_APampl  = infolder+filenames_ampl[i]
    infilename_APdhw   = infolder+filenames_dur[i]
    ...
    ax3.errorbar(iamp_AP_halfwidth,avg_AP_halfwidth,yerr=rms_AP_halfwidth,label=labels[i])
