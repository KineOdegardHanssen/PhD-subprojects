...
model_folders = ['','canin_Konstantoudaki/','canin_Konstantoudaki/BK_kctin_Konstantoudaki/']
labels = ['base','canin','canin, BK']
Nmodels = len(model_folders)

outfolder = 'Compare/Soma%i/' % somasize
plotname = outfolder+'compare_properties_naf_kaf_canin_BK_Konstantoudaki.png'
