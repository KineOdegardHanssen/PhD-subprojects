...
for gcahva in gcahvas:
    for gbk in gbks:
        ...
        ax7.set_title(r'G',y=0,pad=-14,fontsize=18)
        ax8.set_title(r'H',y=0,pad=-14,fontsize=18)
        ...
        ax1.set_title(r'CaHVA (Allen); bk (Hjorth)',loc='right',fontsize=10)
        ...
        ax2.set_title(r'CaHVA (Allen); BK (Zhang)',loc='right',fontsize=10)
        for i in range(Nmodels):
            Nspikes      = []
            iamp_Nspikes = []
        ...
        ax3.set_title(r'CaHVA (Allen); BK (Ait Ouares)',loc='right',fontsize=10)
        for i in range(Nmodels):
            Nspikes      = []
            iamp_Nspikes = []
        ...
        ax4.set_title(r'CaHVA (Allen); SK (Ait Ouares)',loc='right',fontsize=10)
        for i in range(Nmodels):
            Nspikes      = []
            iamp_Nspikes = []
        ...
        ax5.set_title(r'CaHVA (Allen); SK (Allen)',loc='right',fontsize=10)
        for i in range(Nmodels):
            Nspikes      = []
            iamp_Nspikes = []
        ...
        ax6.set_title(r'canin (Konstantoudaki); bk (Hjorth)',loc='right',fontsize=10)
        for i in range(Nmodels):
            Nspikes      = []
            iamp_Nspikes = []
        ...
        ax7.set_title(r'canin (Konstantoudaki); BK (Zhang)',loc='right',fontsize=10)
        for i in range(Nmodels):
            Nspikes      = []
            iamp_Nspikes = []
        ...
        ax8.set_title(r'canin (Konstantoudaki); BK (Ait Ouares)',loc='right',fontsize=10)
        for i in range(Nmodels):
            Nspikes      = []
            iamp_Nspikes = []
        ...
        ax9.set_title(r'canin (Konstantoudaki); SK (Ait Ouares)',loc='right',fontsize=10) #'_gsk'+str(gbk)+'p' + '_gCaHVA'+str(gcahva)+'p_
        for i in range(Nmodels):
            Nspikes      = []
            iamp_Nspikes = []
        ...
        ax10.set_title(r'canin (Konstantoudaki); SK (Allen)',loc='right',fontsize=10)
        for i in range(Nmodels):
            Nspikes      = []
            iamp_Nspikes = []
        ...
        ax11.set_title(r'caq (Hjorth); bk (Hjorth)',loc='right',fontsize=10)
        for i in range(Nmodels):
            Nspikes      = []
            iamp_Nspikes = []
        ...
        ax12.set_title(r'caq (Hjorth); BK (Zhang)',loc='right',fontsize=10)
        for i in range(Nmodels):
            Nspikes      = []
            iamp_Nspikes = []
        ...
        ax15.set_title(r'caq (Hjorth); SK (Allen)',loc='right',fontsize=10)
        for i in range(Nmodels):
            Nspikes      = []
            iamp_Nspikes = []
