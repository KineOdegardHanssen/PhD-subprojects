...
ax8.set_title(r'canin (Konstantoudaki); BK (Ait Ouares)',fontsize=14)
for i in range(Nmodels):
    Nspikes      = []
    iamp_Nspikes = []
...
ax11.set_title(r'canin (Konstantoudaki); SK (Ait Ouares)',fontsize=14) #'_gsk'+str(gbk)+'p' + '_gCaHVA'+str(gcahva)+'p_
for i in range(Nmodels):
    Nspikes      = []
    iamp_Nspikes = []
