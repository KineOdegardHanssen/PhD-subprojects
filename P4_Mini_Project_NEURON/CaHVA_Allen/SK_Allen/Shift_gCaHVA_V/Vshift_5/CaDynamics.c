...
#define cao0 cao0_CaDynamics
 ...
 "cao0_CaDynamics", &cao0_CaDynamics,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 CaDynamics C:/Users/Kine/Documents/Projects_PhD/P4_PNN_channels/Hjorth2020/FS_Na_K/CaHVA_Allen/SK_Allen/CaDynamics.mod\n");
