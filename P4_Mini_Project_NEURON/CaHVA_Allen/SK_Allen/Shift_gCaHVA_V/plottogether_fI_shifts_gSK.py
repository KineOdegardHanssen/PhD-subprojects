...
gnafs   = 1.0
gkafs   = 1.0
gsks    = [0.1,0.5,1.0,2.0]#[0.1,1.0,2.5,10.0]#
gcahva  = 0.2
gpases  = 1.0
...
ax1.set_title(r'$f-I$-plot, %.1f$g_{\mathregular{SK}}$' % gsks[0],fontsize=18)
ax2.set_title(r'$f-I$-plot, %.1f$g_{\mathregular{SK}}$' % gsks[1],fontsize=18)
ax3.set_title(r'$f-I$-plot, %.1f$g_{\mathregular{SK}}$' % gsks[2],fontsize=18)
ax4.set_title(r'$f-I$-plot, %.1f$g_{\mathregular{SK}}$' % gsks[3],fontsize=18)
