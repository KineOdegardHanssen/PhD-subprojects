...
for gcahva in gcahvas:
    ...
    ax1.plot(I_Nspikes,Nspikes, color=colors[i], label=thelabel)
    ax2.errorbar(I_maxima,maxima, yerr=maxima_rms, capsize=2, color=colors[i], label=thelabel)
    ax3.errorbar(I_minima,minima, yerr=minima_rms, capsize=2, color=colors[i], label=thelabel)
    ax4.errorbar(I_dur,dur, yerr=dur_rms, capsize=2, color=colors[i], label=thelabel)
    i+=1
