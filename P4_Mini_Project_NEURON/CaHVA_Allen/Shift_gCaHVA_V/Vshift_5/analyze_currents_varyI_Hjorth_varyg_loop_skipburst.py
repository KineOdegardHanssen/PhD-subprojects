...
def manual(filename,iamp,idelay,idur,spikedurat,skiptime,gcahva):
    """Manual approach"""
    ...
    plt.title('All currents')
    plt.legend(loc='lower left')
    plt.tight_layout()
    plt.savefig('Results/Soma10/Currents/idur%i_iamp'+str(iamp)+'_gcahva'+str(gcahva)+'_allcurrents.png')
    ...
    plt.legend(loc='lower left')
    plt.tight_layout()
    plt.savefig('Results/Soma10/Currents/idur%i_iamp'+str(iamp)+'_gcahva'+str(gcahva)+'_Inaf.png')
    ...
    plt.legend(loc='lower left')
    plt.tight_layout()
    plt.savefig('Results/Soma10/Currents/idur%i_iamp'+str(iamp)+'_gcahva'+str(gcahva)+'_Ikaf.png')
    ...
    plt.legend(loc='lower left')
    plt.tight_layout()
    plt.savefig('Results/Soma10/Currents/idur%i_iamp'+str(iamp)+'_gcahva'+str(gcahva)+'_ICaHVA.png')
    ...
    plt.legend(loc='lower left')
    plt.tight_layout()
    plt.savefig('Results/Soma10/Currents/idur%i_iamp'+str(iamp)+'_gcahva'+str(gcahva)+'_Icap.png')
    ...
    plt.legend(loc='lower left')
    plt.tight_layout()
    plt.savefig('Results/Soma10/Currents/idur%i_iamp'+str(iamp)+'_gcahva'+str(gcahva)+'_Imem.png')
    ...
    plt.legend(loc='lower left')
    plt.tight_layout()
    plt.savefig('Results/Soma10/Currents/idur%i_iamp'+str(iamp)+'_gcahva'+str(gcahva)+'_Ipas.png')
...
if __name__ == '__main__':
    ...
    for gcahva in gcahvas:
        ...
        for j in range(Namps):
            ...
            manual(filename,iamp,idelay,idur,spikedurat,skiptime,gcahva)
            '''
