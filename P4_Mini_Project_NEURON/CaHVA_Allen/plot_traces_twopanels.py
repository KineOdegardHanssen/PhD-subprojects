...
plt.tight_layout()
plt.savefig('Results/Soma10/Compare/trace_twopanels_idur'+str(idur)+'_iamp'+str(iamp)+'_aligned.png')
plt.show()
...
if plotitall==True:
    ...
    ax2.legend(loc='upper left',ncol=1,fontsize=11)
    plt.tight_layout()
    plt.savefig('Results/Soma10/Compare/trace_twopanels_idur'+str(idur)+'_iamp'+str(iamp)+'_unaligned.png')
    plt.show()
