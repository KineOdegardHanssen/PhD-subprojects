...
ax3.set_title(r'$f-I$-plot, %.1f$g_{\mathregular{CaHVA}}$' % (5.0*gcahvas[1]),fontsize=18)
ax5.set_title(r'$f-I$-plot, %.1f$g_{\mathregular{CaHVA}}$' % (5.0*gcahvas[2]),fontsize=18)
ax7.set_title(r'$f-I$-plot, %.1f$g_{\mathregular{CaHVA}}$' % (5.0*gcahvas[3]),fontsize=18)
...
for i in range(NV):
    ...
    if numpy.sum(Nspikes)>0:
        if vshifts[i]==0:
            ax5.plot(I_Nspikes, Nspikes, label=r'$V_{\mathregular{shift}}$ = %s mV' % str(vshifts_label[i]),linewidth=3,color=colors[i])
        else:
            ax5.plot(I_Nspikes, Nspikes, label=r'$V_{\mathregular{shift}}$ = %s mV' % str(vshifts_label[i]),linewidth=2,color=colors[i])
...
for i in range(NV):
    ...
    if numpy.sum(Nspikes)>0:
        if vshifts[i]==0:
            ax7.plot(I_Nspikes, Nspikes, label=r'$V_{\mathregular{shift}}$ = %s mV' % str(vshifts_label[i]),linewidth=3,color=colors[i])
        else:
            ax7.plot(I_Nspikes, Nspikes, label=r'$V_{\mathregular{shift}}$ = %s mV' % str(vshifts_label[i]),linewidth=2,color=colors[i])
...
ax2.set_title(r'$f-I$-plot, %.1f$g_{\mathregular{SK}}$' % gsks[0],fontsize=18)
ax4.set_title(r'$f-I$-plot, %.1f$g_{\mathregular{SK}}$' % gsks[1],fontsize=18)
ax6.set_title(r'$f-I$-plot, %.1f$g_{\mathregular{SK}}$' % gsks[2],fontsize=18)
...
for i in range(NV):
    ...
    if numpy.sum(Nspikes)!=0:
        if vshifts[i]==0:
            ax6.plot(I_Nspikes, Nspikes, label=r'$V_{\mathregular{shift}}$ = %s mV' % str(vshifts_label[i]),linewidth=3,color=colors[i])
        else:
            ax6.plot(I_Nspikes, Nspikes, label=r'$V_{\mathregular{shift}}$ = %s mV' % str(vshifts_label[i]),linewidth=2,color=colors[i])
...
for i in range(NV):
    ...
    if numpy.sum(Nspikes)!=0:
        if vshifts[i]==0:
            ax8.plot(I_Nspikes, Nspikes, label=r'$V_{\mathregular{shift}}$ = %s mV' % str(vshifts_label[i]),linewidth=3,color=colors[i])
        else:
            ax8.plot(I_Nspikes, Nspikes, label=r'$V_{\mathregular{shift}}$ = %s mV' % str(vshifts_label[i]),linewidth=2,color=colors[i])
