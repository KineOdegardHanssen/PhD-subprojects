...
gnafs         = 1.0
gkafs         = 1.0
gcahvas       = [0.02,0.2,0.4]#[0.1,0.5,1.0,2.0] # Possibly change these. A lot of simulations need to be run first
gpases        = 1.0
...
ax3.set_title(r'$f-I$-plot, %.1f$\bar{g}_{\mathregular{CaHVA}}$' % (5.0*gcahvas[1]),fontsize=18)
ax5.set_title(r'$f-I$-plot, %.1f$\bar{g}_{\mathregular{CaHVA}}$' % (5.0*gcahvas[2]),fontsize=18)
...
ax2.set_title(r'$f-I$-plot, %.1f$\bar{g}_{\mathregular{SK}}$' % gsks[0],fontsize=18)
ax4.set_title(r'$f-I$-plot, %.1f$\bar{g}_{\mathregular{SK}}$' % gsks[1],fontsize=18)
ax6.set_title(r'$f-I$-plot, %.1f$\bar{g}_{\mathregular{SK}}$' % gsks[2],fontsize=18)
...
ax6.legend(loc='upper left',ncol=2)#,ncol=1)
fig.tight_layout()
if live==False:
    plt.savefig(figname)
else:
