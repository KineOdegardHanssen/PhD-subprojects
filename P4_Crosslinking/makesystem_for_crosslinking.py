...
if onechain==True:
    ...
    gridspacing   = 2   # Huuuge spacing in the grid in order to only study ONE chain (this will affect the box size)
else:
    M             = 9   # Number of chains
    L2            = 3   # Determining the shape of the L1xL2 polymer grid on the surface
    gridspacing   = 10 # The spacing in our grid
substratecharge = 0
charge          = -1
mass            = 1
Nelem           = M*(N+1)
...
if mass<1:
    outfilename = '/home/kine/Documents/Backup2_P2_PolymerMD/P3_Crosslinking/Spacing'+str(gridspacing)+'/Sigma_free_1/Initial_configurations/Before_bead/data.chaingrids_substrate_N%i_Nchains%i_Ly%i_gridspacing'% (Nelem,M,L2)+str(gridspacing)+'_twofixed_charge%i_mass%.5f' % (charge,mass)
else:
    outfilename = '/home/kine/Documents/Backup2_P2_PolymerMD/P3_Crosslinking/Spacing'+str(gridspacing)+'/Sigma_free_1/Initial_configurations/Before_bead/data.chaingrids_substrate_N%i_Nchains%i_Ly%i_gridspacing'% (Nelem,M,L2)+str(gridspacing)+'_twofixed_charge%i_mass%i' % (charge,mass)
