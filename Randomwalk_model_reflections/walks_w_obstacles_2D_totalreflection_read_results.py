...
if hitprobs[0]==0:
    outfilename = 'D_vs_hitprobs_Nsteps%i_Nreal%i_2D_totref_with0.txt' %(Nsteps,Nreal)
    plotname = 'D_vs_hitprobs_Nsteps%i_Nreal%i_2D_totref_with0.png' %(Nsteps,Nreal)
else:
    outfilename = 'D_vs_hitprobs_Nsteps%i_Nreal%i_2D_totref.txt' %(Nsteps,Nreal)
    plotname = 'D_vs_hitprobs_Nsteps%i_Nreal%i_2D_totref.png' %(Nsteps,Nreal)
plotname2 = 'D_vs_1dsqrthitprobs_Nsteps%i_Nreal%i_2D_totref.png' %(Nsteps,Nreal)
plotname3 = 'D_vs_1dhitprobs_Nsteps%i_Nreal%i_2D_totref.png' %(Nsteps,Nreal)
